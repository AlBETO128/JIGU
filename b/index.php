            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="tambah.php" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step=0.01 name="Precio" class=" form-control" placeholder="700 EJ" required>
                    </div>
                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="number" step=0.01 name="edit_Precio" id="edit_Precio" class=" form-control" placeholder="3.52" required>
                            </div>
